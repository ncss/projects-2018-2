...
/* POSTS example data */
INSERT INTO posts(id, charity_id, post_type, timestamp, content_text, content_image, content_event_time, content_event_location) VALUES (0, 2, 'event', '2018,1,12,1,48,0', 'Come help volunteer at our Bubble Tea Drive for Shelless Snails', 'https://i2.wp.com/blog.numitea.com/wp-content/uploads/2017/03/Chai-Bubble-Tea-prepared.jpg?resize=1000%2C820', '2018,1,14,6,30,0', 'Intergalactic Snail Centre');
INSERT INTO posts(id, charity_id, post_type, timestamp, content_text, content_image, content_event_time, content_event_location) VALUES (1, 0, 'event', '2018,1,10,2,54,0', 'Help setup our example charity event!', 'http://4.bp.blogspot.com/-bGl3TyNbxj8/TWV6okw-3SI/AAAAAAAAAAg/FvdOHVZpXR4/s1600/UNRWA_Gaza5.jpg', '2018,5,3,13,13,13', 'OLPC fundraiser centre');
